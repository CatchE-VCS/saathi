import 'package:saathi/models/user_model.dart';
import 'package:saathi/models/user_post_model.dart';

class Data {
  static final List<PostModel> postList = [
    PostModel(
        name: "Ankita Jha",
        profileUrl: "assets/profile1.jpg",
        headline: "Author ",
        tags: " #nevergiveup #staypositive #staystrong #positiveattitude",
        description:
        ...
        likes: "800",
        postAdded: DateTime.parse("2023-02-03T20:53:12.185Z"),
        id: "1"),
    PostModel(
        name: "Anonymous",
